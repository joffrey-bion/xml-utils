 ...
 * <p>
 * Each parameter has a unique name (a key) to be referred to, and can be required or
 * optional. When optional, a default value must be provided. One can also specify a
 * short description for each parameter.
 * </p>
 * <p>
 * Each parameter is associated to a {@link Serializer}, which also indicates its
 * class.
 * </p>
 * 
...
public class ParamsSchema {
    ...
    /**
     * The name of this schema, only used when serializing a {@link Parameters}
     * object to an XML file.
     */
    final String name;
    /**
     * The String indicating the version of the parameters that this schema
     * describes.
     */
     ...
     * 
     * @param version
     *            The version of the parameters set that this schema describes. If
     *            several schemas are provided, this allows to select the schema to
     *            use when deserializing the XML file.
     */
     ...
     * 
     * @param name
     *            The name of this schema, only used when serializing a
     *            {@link Parameters} object to an XML file.
     * @param version
     *            The version of the parameters set that this schema describes. If
     *            several schemas are provided, this allows to select the schema to
     *            use when deserializing the XML file.
     ...
     */
    public <T> void addParam(String key, Serializer<T> serializer, boolean required, T defaultValue) {
        add(new ParamSpec(key, serializer, required, defaultValue, null));
    }
     ...
     *            A description of this parameter.
     */
    public <T> void addParam(String key, Serializer<T> serializer, boolean required,
            T defaultValue, String description) {
        add(new ParamSpec(key, serializer, required, defaultValue, description));
    }

    /**
     * Adds all the specifications in the given {@link ParamsSchema} to this
     * parameters schema.
     * 
     * @param schema
     *            The schema to add.
    ...
    /**
     * Returns {@code true} if all the specifications defined in the given
     * {@link ParamsSchema} exist in this parameters schema, and if they are all
     * identical as defined by {@link ParamSpec#equals(Object)}.
     * 
     * @param otherSchema
     *            The whole schema to add.
     * @return {@code true} if all the specifications defined in the given
     *         {@link ParamsSchema} exist in this parameters schema, and if they are
     *         all identical as defined by {@link ParamSpec#equals(Object)}. <br/>
     *         {@code false} if at least one {@link ParamSpec} is absent from this
     *         schema. <br/>
     *         {@code false} if at least one {@link ParamSpec} appears with the same
     *         key in this schema and {@code otherSchema} but is not the same as
     *         defined by {@link ParamSpec#equals(Object)}.
     */
